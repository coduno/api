...
// Save will put this DiffTestResult into Datastore using the given key.
func (ƨ DiffTestResult) Save(ctx context.Context, key *datastore.Key) (*datastore.Key, error) {
	if key != nil {
...
// SaveWithParent can be used to save this DiffTestResult as child of another
// entity.
// This will error if parent == nil.
func (ƨ DiffTestResult) SaveWithParent(ctx context.Context, parent *datastore.Key) (*datastore.Key, error) {
	if parent == nil {
